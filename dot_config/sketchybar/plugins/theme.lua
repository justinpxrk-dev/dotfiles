...
--- Each instance supplies its own `on_change`: both bars repaint their themed background
--- and recolor all their items (space boxes, glyphs, pill) from the live palette.
