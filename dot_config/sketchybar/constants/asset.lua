...
local asset_dir = os.getenv("HOME") .. "/.local/share/chezmoi/Assets"

--- @type Asset
local M = {
	NOW_PLAYING = {
		ARTWORK = {
			DEFAULT_IMAGE_DARK_TRANSPARENT = asset_dir .. "/apple_music/logo_dark_24_24.png",
			DEFAULT_IMAGE_LIGHT_TRANSPARENT = asset_dir .. "/apple_music/logo_light_24_24.png",
