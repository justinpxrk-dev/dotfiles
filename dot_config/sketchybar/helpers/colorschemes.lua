...
local colorschemes = {
	MACOS_TAHOE_DARK = {
		ACTIVE_SPACE_ICON = 0xff738e64,
		BACKGROUND = 0x991e1e1e,
		BORDER = 0x991e1e1e,
		GRAPH = 0xff738e64,
		GRAPH_FILL = 0x995f7951,
		ICON = 0xff738e64,
		INACTIVE_LABEL = 0x995f7951,
		INACTIVE_SPACE_ICON = 0x995f7951,
		LABEL = 0xff738e64,
	},
	MACOS_TAHOE_LIGHT = {
		ACTIVE_SPACE_ICON = 0xff000000,
		BACKGROUND = 0x99ffffff,
		BORDER = 0x99ffffff,
		GRAPH = 0xff000000,
		GRAPH_FILL = 0x99000000,
		ICON = 0xff000000,
		INACTIVE_LABEL = 0x99000000,
		INACTIVE_SPACE_ICON = 0x99000000,
		LABEL = 0xff000000,
	},
}
